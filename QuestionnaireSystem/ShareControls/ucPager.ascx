...
<div class="Pager">
    <a runat="server" id="aLinkFirst" href="Index.aspx?Page=1">第一頁 </a>
    <a runat="server" id="aLinkPrev" href="Index.aspx?Page=1">上一頁 </a>
    ...
    <a runat="server" id="aLinkNext" href="Index.aspx?Page=3">下一頁 </a>
    <a runat="server" id="aLinkLast" href="Index.aspx?Page=10">最未頁 </a>
</div>
