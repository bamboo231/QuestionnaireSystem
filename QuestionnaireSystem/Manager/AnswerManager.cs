...
namespace QuestionnaireSystem.Manager
{
    public class AnswerManager
    {
        ...
        public List<BasicAnswer> GetDoneList(string QnirID)
        {
            ...
            {
                Logger.WriteLog("AnswerManager.GetDoneList", ex);
                throw;
            }
        }
        ...
        /// 取得此問卷的所有回覆List
        /// </summary>
        /// <param name="QnirID">傳入值為問卷ID(int)</param>
        /// <returns>回傳值為List<BasicAnswer></returns>
        public List<BasicAnswer> GetDoneList(int qnirID, bool isNewQstnir)
        {
            try
            {
                ...
                else
                {
                    using (ContextModel contextModel = new ContextModel())
                    {
                        List<BasicAnswer> basicAnswerList = contextModel.BasicAnswers.Where(obj => obj.QuestionnaireID == qnirID).ToList();
                        return basicAnswerList;
                    }
                }
            }
